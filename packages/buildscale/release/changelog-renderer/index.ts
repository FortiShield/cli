...
import { BuildscaleReleaseConfig } from '../../src/command-line/release/config/config';
 ...
 * from the user's buildscale.json configuration and passed as is into the ChangelogRenderer function.
 */
...
/**
 * The specific options available to the default implementation of the ChangelogRenderer that buildscale exports
 * for the common case.
 */
...
/**
 * The default ChangelogRenderer implementation that buildscale exports for the common case of generating markdown
