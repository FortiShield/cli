...
export function assertWorkspaceValidity(
  ...
  if (buildscaleJson.implicitDependencies) {
    output.warn({
      ...
      bodyLines: [
        'Use "namedInputs" instead. You can run "buildscale repair" to automatically migrate your configuration.',
        'For more information about the usage of "namedInputs" see https://buildscale.github.io/deprecated/global-implicit-dependencies#global-implicit-dependencies',
      ],
    });
  }
