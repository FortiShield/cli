...
const rootMarkers = ['buildscale.json', 'buildscale', .buildscalew.bat'];
...
describe('workspaceRootInner', () => {
  ...
  it.each(rootMarkers)(
    'should prefer workspace root from %s when in subpackage containing buildscale',
    (marker) => {
      jest
        .spyOn(fileUtils, 'fileExists')
        .mockImplementation((p) =>
          [
            `/home/workspace/${marker}`,
            '/home/workspace/packages/a/node_modules/buildscale/package.json',
            '/home/workspace/packages/a/package.json',
            '/home/workspace/packages/b/package.json',
            '/home/workspace/packages/c/package.json',
          ].includes(p.toString())
  ...
  it('should find workspace root from installation when marker not present', () => {
    jest
      ...
      .mockImplementation((p) =>
        [
          `/home/workspace/node_modules/buildscale/package.json`,
          '/home/workspace/packages/a/package.json',
          '/home/workspace/packages/b/package.json',
          '/home/workspace/packages/c/package.json',
        ].includes(p.toString())
