 ...
 */
export const ONLY_MODIFIES_EXISTING_TARGET = 'BUILDSCALE_ONLY_MODIFIES_EXISTING_TARGET';

/**
 * This is used to override the source file for the target defaults plugin.
 * This allows the plugin to use the project files as the context, but point to buildscale.json as the source file.
 *
 * NOTE: This cannot be a symbol, as they are not serialized in JSON the communication
 * between the plugin-worker and the main process.
 */
export const OVERRIDE_SOURCE_FILE = 'BUILDSCALE_OVERRIDE_SOURCE_FILE';
