...
jest.mock('@buildscale/devkit', () => ({
  ...jest.requireActual<any>('@buildscale/devkit'),
  workspaceRoot: '/root',
}));
  ...
  describe('next.js generated', () => {
    ...
    beforeEach(() => {
      ...
      const ctx: CreateDependenciesContext = {
        ...
        buildscaleJsonConfiguration: null,
...
`;
  ...
  describe('auxiliary tagged version ranges', () => {
    beforeEach(() => {
      const fileSys = {
        'node_modules/@nrwl/buildscale-cloud/package.json': '{"version": "16.1.1"}',
        'node_modules/buildscale-cloud/package.json': '{"version": "16.1.1"}',
        'node_modules/postgres/package.json': '{"version": "3.2.4"}',
      };
      vol.fromJSON(fileSys, '/root');
    });
...
"@nrwl/buildscale-cloud@16.1.1":
  version "16.1.1"
  resolved "http://localhost:4873/@nrwl%2fbuildscale-cloud/-/buildscale-cloud-16.1.1.tgz#9e1ed2acff11ab0ae8a4c0c045d412034ac26be7"
  integrity sha512-iJIPP46+saFZK748FKU4u4YZH+Sv3ZvZPbMwGVMhwqhOYcrlO5aSa0lpilyoN8WuhooKNqcCfiqshx6V577fTg==
  dependencies:
    buildscale-cloud "16.1.1"

buildscale-cloud@16.1.1, buildscale-cloud@latest:
  version "16.1.1"
  resolved "http://localhost:4873/buildscale-cloud/-/buildscale-cloud-16.1.1.tgz#103ae0f13f5eb05d6ddd6d9bfcafc56cf295a59a"
...
postgres@charsleysa/postgres#fix-errors-compiled:
  ...
  `;
      ...
      expect(externalNodes['npm:@nrwl/buildscale-cloud']).toMatchInlineSnapshot(`
        {
          "data": {
            "hash": "sha512-iJIPP46+saFZK748FKU4u4YZH+Sv3ZvZPbMwGVMhwqhOYcrlO5aSa0lpilyoN8WuhooKNqcCfiqshx6V577fTg==",
            "packageName": "@nrwl/buildscale-cloud",
            "version": "16.1.1",
          },
          "name": "npm:@nrwl/buildscale-cloud",
          "type": "npm",
        }
      `);
      expect(externalNodes['npm:buildscale-cloud']).toMatchInlineSnapshot(`
        {
          "data": {
            "hash": "sha512-Rq7ynvkYzAJ67N3pDqU6cMqwvWP7WXJGP4EFjLxgUrRHNCccqDPggeAqePodfk3nZEUrZB8F5QBKZuuw1DR3oA==",
            "packageName": "buildscale-cloud",
            "version": "16.1.1",
          },
          "name": "npm:buildscale-cloud",
          "type": "npm",
        }
      `);
      expect(externalNodes['npm:postgres']).toMatchInlineSnapshot(`
...
buildscale-cloud@latest, buildscale-cloud@16.1.1:
  version "16.1.1"
  resolved "http://localhost:4873/buildscale-cloud/-/buildscale-cloud-16.1.1.tgz#103ae0f13f5eb05d6ddd6d9bfcafc56cf295a59a"
  integrity sha512-Rq7ynvkYzAJ67N3pDqU6cMqwvWP7WXJGP4EFjLxgUrRHNCccqDPggeAqePodfk3nZEUrZB8F5QBKZuuw1DR3oA==
  dependencies:
  ...
  describe('duplicate packages', () => {
    beforeEach(() => {
      const fileSys = {
        ...
        'node_modules/lru-cache/package.json': '{"version": "6.0.0"}',
        'node_modules/minimatch/package.json': '{"version": "3.1.2"}',
        'node_modules/buildscale/package.json': '{"version": "15.4.0"}',
        'node_modules/p-limit/package.json': '{"version": "3.1.0"}',
        'node_modules/semver/package.json': '{"version": "6.3.0"}',
        'node_modules/strip-bom/package.json': '{"version": "3.0.0"}',
        'node_modules/supports-color/package.json': '{"version": "7.2.0"}',
  ...
  describe('pruning', () => {
    beforeEach(() => {
      const fileSys = {
        ...
        'node_modules/buildscale/package.json': '{"version": "15.4.5"}',
        'node_modules/once/package.json': '{"version": "1.4.0"}',
      ...
      expect(graph.externalNodes).toMatchInlineSnapshot(`
        {
          ...
          "npm:string-width": {
            "data": {
              "hash": "sha512-HnLOCR3vjcY8beoNLtcjZ5/buildscalen2afmME6lhrDrebokqMap+XbeW8n9TXpPDOqdGK5qcI3oT0GKTW6wC7EMiVqA==",
