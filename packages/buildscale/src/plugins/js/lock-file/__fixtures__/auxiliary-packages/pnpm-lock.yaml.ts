...
dependencies:
  '@nrwl/devkit': 15.0.13_buildscale@15.3.0+typescript@4.8.4
...
packages:
  ...
  /@nrwl/devkit/15.0.13_buildscale@15.3.0+typescript@4.8.4:
    resolution: {integrity: sha512-/8k7wbBRFf2UC+T4F+vWMy3bfSGi+uK6RwXk53moLq.buildscalew.hXaQhRiCqasC6VJFUw3zK6luu2T7xkPUlA9K9l4w==}
    peerDependencies:
      buildscale: '>= 14 <= 16'
    dependencies:
