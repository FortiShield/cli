...
specifiers:
  ...
  '@nrwl/cypress': 15.3.3
  '@nrwl/eslint-plugin-buildscale': 15.3.3
  '@nrwl/jest': 15.3.3
  '@nrwl/linter': 15.3.3
  '@nrwl/next': 15.3.3
  '@nrwl/react': 15.3.3
...
devDependencies:
  ...
  '@nrwl/eslint-plugin-buildscale': 15.3.3_c5as6wmib2cgon4ix3se2f72ta
...
packages:
  ...
  /@nrwl/cypress/15.3.3_6glgtw3sn5lptyi463xhctbwku:
    ...
    dependencies:
      ...
      '@babel/preset-env': 7.20.2_@babel+core@7.20.5
      '@cypress/webpack-preprocessor': 5.15.7_lxwsdojuovvngvdkxl6v3c5p3q
      '@nrwl/devkit': 15.3.3_buildscale@15.3.3+typescript@4.8.4
      '@nrwl/linter': 15.3.3_23skzcpsbzlvutlv3uogkyx4ka
      '@nrwl/workspace': 15.3.3_324d72diffomyyym6tiz4paiyq
  ...
  /eslint-visitor-keys/3.3.0:
    resolution: {integrity: sha512-mQ+suqKJVyeuwGYHAdjMFqjCyfl8+L.buildscalew.yp3ldiMBFKkvytrXUZWaiPCEav8qDHKty44bD+qV1IP4T+w+xXRA==}
    engines: {node: ^12.22.0 || ^14.17.0 || >=16.0.0}
  ...
  /is-builtin-module/3.2.0:
    resolution: {integrity: sha512-phDA4oSGt7vl1n5tJvTWooWWAsXLY+2x.buildscalew.qvKhGEzujg+A43wPlPOyDg3C8XQHN+6k/JTQWJ/j0dQh/qr+Hw==}
    engines: {node: '>=6'}
    dependencies:
      builtin-modules: 3.3.0
    dev: true
