    ...
    beforeEach(() => {
      const fileSys = {
        'node_modules/@nrwl/devkit/package.json':
          '{"peerDependencies":{"buildscale":">= 14 <= 16"}}',
        ...
        'node_modules/buildscale/package.json':
