...
describe('explicit project dependencies', () => {
  ...
  describe('static imports, dynamic imports, and commonjs requires', () => {
    ...
    it('should not build explicit dependencies when buildscale-ignore-next-line comments are present', async () => {
      const source = 'proj';
      const ctx = await createContext({
        source,
        sourceProjectFiles: [
          ...
          },
          {
            ...
            content: `
              ...
              /* eslint-ignore */ /* buildscale-ignore-next-line */
              import { foo } from '@proj/proj4ab'; import { foo } from '@proj/project-3';
    ...
    it('should not build explicit dependencies for stringified or templatized import/require statements', async () => {
      ...
      const ctx = await createContext({
        ...
        sourceProjectFiles: [
           ...
           * currently causes Buildscale to interpret the import/require as if they were not templatized and were declarared directly
           * in the source code.
           */
          // Also reported here: https://github.com/buildscale/cli/issues/8938
          // {
...
async function createContext(
  ...
  const [plugins, cleanup] = await loadBuildscalePlugins([], tempFs.tempDir);
