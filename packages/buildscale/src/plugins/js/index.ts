...
export const name = 'buildscale.js/dependencies-and-lockfile';
...
export const createNodes: CreateNodes = [
  ...
  (lockFile, _, context) => {
    const pluginConfig = jsPluginConfig(context.buildscaleJsonConfiguration);
...
export const createDependencies: CreateDependencies = (
  ...
  const pluginConfig = jsPluginConfig(ctx.buildscaleJsonConfiguration);
...
function getLockFileHash(lockFileContents: string) {
  return hashArray([buildscaleVersion, lockFileContents]);
}
