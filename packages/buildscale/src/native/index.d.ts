...
export interface BuildscaleJson {
  namedInputs?: Record<string, Array<JsInputs>>
}
...
export interface Buildscale.orkspaceFiles {
  projectFileMap: ProjectFiles
  globalFiles: Array<FileData>
  externalReferences?: Buildscale.orkspaceFilesExternals
}
export interface Buildscale.orkspaceFilesExternals {
...
export function testOnlyTransferFileMap(projectFiles: Record<string, Array<FileData>>, nonProjectFiles: Array<FileData>): Buildscale.orkspaceFilesExternals
...
export class HashPlanner {
  constructor(buildscaleJson: BuildscaleJson, projectGraph: ExternalObject<ProjectGraph>)
...
export class WorkspaceContext {
  ...
  getWorkspaceFiles(projectRootMap: Record<string, string>): Buildscale.orkspaceFiles
