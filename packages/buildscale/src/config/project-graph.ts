...
import { BuildscaleJsonConfiguration } from './buildscale-json';
 ...
 * @deprecated The {@link ProjectGraphProcessor} is deprecated. This will be removed in Buildscale 19.
 */
export interface ProjectGraphProcessorContext {
  /**
   * Workspace information such as projects and configuration
   * @deprecated use {@link projectsConfigurations} or {@link buildscaleJsonConfiguration} instead
   */
  workspace: Workspace;

  projectsConfigurations: ProjectsConfigurations;

  buildscaleJsonConfiguration: BuildscaleJsonConfiguration;
