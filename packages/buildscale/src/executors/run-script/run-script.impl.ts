...
export default async function (
  ...
  try {
    ...
    let env = process.env;
    // when running buildscale through npx with node_modules installed with npm, the path gets modified to include the full workspace path with the node_modules folder
