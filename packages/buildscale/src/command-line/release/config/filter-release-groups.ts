...
export type ReleaseGroupWithName = BuildscaleReleaseConfig['groups'][string] & {
  name: string;
};
      ...
      error: {
        title: groupsFilter
          ...
          : // Getting to this point should be impossible, as we should have explicitly handled any errors/invalid config by now
            `No projects could be matched for versioning, please report this case and include your buildscale.json config and command line arguments`,
      },
      releaseGroups: [],
      releaseGroupToFilteredProjects,
    };
