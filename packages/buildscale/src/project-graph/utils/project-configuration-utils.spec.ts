...
import { BuildscalePluginV2 } from '../plugins';
...
describe('project-configuration-utils', () => {
    ...
    describe('source map', () => {
      ...
      it('should merge generator property', () => {
        ...
        assertCorrectKeysInSourceMap(
          sourceMap,
          'libs/lib-a',
          ['generators.@buildscale/angular:component.option1', 'dummy2'],
          ['generators.@buildscale/angular:component.option2', 'dummy'],
          ['generators.@buildscale/angular:component.option3', 'dummy2']
        );
      });
    });
  });
  ...
  describe('createProjectConfigurations', () => {
    ...
    const fakeTagPlugin: BuildscalePluginV2 = {
    ...
    it('should create nodes for files matching included patterns only', async () => {
      const projectConfigurations = await createProjectConfigurations(
        ...
        [new LoadedBuildscalePlugin(fakeTagPlugin, { plugin: fakeTagPlugin.name })]
      );
    ...
    it('should create nodes for files matching included patterns only', async () => {
      const projectConfigurations = await createProjectConfigurations(
        ...
        ['libs/a/project.json', 'libs/b/project.json'],
        [
          new LoadedBuildscalePlugin(fakeTagPlugin, {
