...
import { loadBuildscalePlugins } from '../../plugins/internal-api';
import { combineGlobPatterns } from '../../../utils/globs';

export const getTouchedProjectsFromProjectGlobChanges: TouchedProjectLocator =
  async (touchedFiles, projectGraphNodes, buildscaleJson): Promise<string[]> => {
    const [plugins] = await loadBuildscalePlugins(buildscaleJson?.plugins ?? [], workspaceRoot);
